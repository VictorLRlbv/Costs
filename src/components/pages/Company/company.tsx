  ...
  return (
    <Container customClass="column">
      <CompanyDescription className="descriptionContainer">
        ...
        <p>
          Alcance novos patamares de sucesso com nossos Planos de Gerenciamento
          de Projetos. Soluções personalizadas para atender às necessidades da
          sua empresa.
        </p>
        <p>
      ...
      <Card
        url="https://wsltech.com.br/wp-content/uploads/2022/09/empresaria-no-cafe_1157-5421.jpg"
        fotoLeft={true}
      ...
      />
      <Card
        url="https://img.freepik.com/fotos-gratis/homem-de-negocios-proprietario-da-empresa-no-escritorio_1303-16046.jpg"
        fotoLeft={false}
      ...
      />
      <Card
        url="https://media.istockphoto.com/id/1217114493/pt/foto/business-woman-hands-stirring-coffee-checking-phone-at-night.jpg?s=612x612&w=0&k=20&c=bxfspoGdGksCnmZji9IZuEyDrmv1wABfxNr8fOQiVvs="
        fotoLeft={true}
